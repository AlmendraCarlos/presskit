...
const hero = { url: "./media/hero.jpg" };
const about = { url: "./media/about.jpg" };
const g1 = { url: "./media/gallery1.jpg" };
const g2 = { url: "./media/gallery2.png" };
const g3 = { url: "./media/gallery3.jpg" };
  ...
  return (
    <section id="top" className="relative min-h-screen overflow-hidden grain">
      <div className="absolute inset-0">
        <img
          src={hero.url}
          alt="ALMENDR4C4RLOS performing live"
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 min-h-screen flex flex-col justify-end pb-20 pt-32">
        <div className="fade-up">
          <div className="font-mono text-[11px] uppercase tracking-[0.3em] text-muted-foreground mb-6">
            ◉ {t("hero.tag")}
          </div>
          <h1 className="font-display font-bold text-[clamp(2.75rem,9vw,9rem)] leading-[0.9] text-balance max-w-5xl">
            {t("hero.title")}
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-3">
            <a
              href="#booking"
              className="group inline-flex items-center gap-3 bg-foreground text-background px-6 py-3.5 text-sm font-medium hover:bg-foreground/90 transition-colors"
            >
              {t("hero.cta")}
            ...
            <a
              href="#sets"
              className="inline-flex items-center gap-3 border border-border px-6 py-3.5 text-sm font-medium hover:bg-accent transition-colors"
            >
...
function Section({
  ...
  return (
    <section id={id} className="py-24 md:py-36 max-w-[1400px] mx-auto px-6 lg:px-10">
      ...
      <h2 className="font-display font-bold text-4xl md:text-6xl tracking-tight mb-14 max-w-3xl text-balance">
        {title}
      </h2>
      {children}
    </section>
...
function Sets() {
  ...
  return (
    <Section id="sets" kicker={t("sets.kicker")} title={t("sets.title")}>
      <p className="max-w-2xl text-muted-foreground mb-12 -mt-8 text-base md:text-lg">
        {t("sets.subtitle")}
      </p>
      ...
      <div className="mt-12">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group inline-flex items-center gap-3 border border-border px-6 py-3.5 text-sm font-medium hover:bg-accent transition-colors"
        >
  ...
  return (
    <Section id="gallery" kicker={t("gallery.kicker")} title={t("gallery.title")}>
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4">
        {imgs.map((im, i) => (
          <div key={i} className="overflow-hidden bg-card aspect-square">
            <img
              src={im.url}
  ...
  const items = [
    {
      ...
      meta: "PDF",
      href: (lang === "es" ? bioEs.url : bioEn.url),
        ...
        {items.map((it) => {
          ...
          return (
            <a
              ...
              className="group bg-background hover:bg-card transition-colors p-6 md:p-8 flex flex-col justify-between min-h-[240px]"
            >
...
function Booking() {
  ...
  const channels = [
    ...
    {
      icon: () => <span className="font-mono text-xs font-bold">WA</span>,
  ...
  return (
    <section id="booking" className="border-t border-border bg-card">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-24 md:py-36">
        ...
        <h2 className="font-display font-bold text-4xl md:text-7xl tracking-tight mb-8 max-w-4xl text-balance">
          {t("booking.title")}
        </h2>
        <p className="max-w-2xl text-muted-foreground text-base md:text-lg mb-16">
          {t("booking.subtitle")}
        </p>
          ...
          {channels.map((c) => {
            ...
            return (
              <a
                ...
                rel="noreferrer"
                className="group bg-card hover:bg-background transition-colors p-6 flex flex-col justify-between min-h-[180px]"
              >
                ...
                <div>
                  ...
                  <div className="font-display font-medium text-sm md:text-base break-all">
                    {c.value}
                  </div>
                </div>
              </a>
